...
func (k *KeyPair) EncryptInt(v *big.Int) *big.Int {
	return EncryptInt(k.Prime, k.Enc, v)
}

// DecryptInt returns v decrypted with Dec.
func (k *KeyPair) DecryptInt(v *big.Int) *big.Int {
	return DecryptInt(k.Prime, k.Dec, v)
}

func EncryptInt(prime *big.Int, encKey *big.Int, v *big.Int) *big.Int {
	return new(big.Int).Exp(v, encKey, prime)
}

func DecryptInt(prime *big.Int, decKey *big.Int, v *big.Int) *big.Int {
	return new(big.Int).Exp(v, decKey, prime)
}
